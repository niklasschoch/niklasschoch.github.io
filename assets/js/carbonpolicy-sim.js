(async function () {
  ...
  function generateDescription(outcome, market, instrument, cbam, level) {
    ...
    const descriptions = {
      "emissions_total": `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}. Emissions represent the total carbon dioxide equivalent released by the French cement industry over time.`,
      "profit_total": `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}. Profit represents the total economic surplus generated by domestic producers in the French cement industry.`,
      "marketQuantity": `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}. Market quantity represents the total amount of cement supplied and demanded in the market.`,
      "imports": `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}. Imports represent the quantity of cement imported from outside the French market.`,
      "price": `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}. Price represents the market equilibrium price of cement.`
    };
    
    return descriptions[outcome] || `This plot shows the evolution of ${outcomeDesc} in the ${marketText} market under a ${instrumentText} policy ${cbamText}${levelText}.`;
  }
